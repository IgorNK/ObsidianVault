In this example method clearCart from Cart class is forwarded to CartTotal component as a prop, and updateProduct method is forwarded from Cart to Product component.
It's best to keep common methods in the highest common parent component. In this case, it is Cart.
```
